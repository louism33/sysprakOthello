                        ...
                        BOARD_STRUCT *thinkerBoard, infoVonServer *info, pid_t thinker, pid_t connector, Player *myPlayer, Player *gegner)
{
    ...
    performConnectionLouis(sock, gameID, player,
                           configurationStruct->gamekindname, connectorBoard, thinkerBoard, info, thinker, connector, myPlayer, gegner);
...
int connectorMasterMethod(BOARD_STRUCT *connectorBoard, BOARD_STRUCT *thinkerBoard, int argc, char *argv[], infoVonServer *info, pid_t thinker, pid_t connector, Player *myPlayer, Player *gegner)
{
    char *gameID;
    char *player = 0;
    int ret;
    ...
    connectToGameServer(mockGame, gameID, player, usingCustomConfigFile,
                        configPath, connectorBoard, thinkerBoard, info, thinker, connector, myPlayer, gegner);
